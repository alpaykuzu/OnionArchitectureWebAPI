...
namespace OnionArchitectureWebAPI.Infrastructure.RedisCache
{
    public class RedisCacheService : IRedisCacheService
    {
        ...
        {
            TimeSpan timeUnitExpiration = expirationTime.HasValue ? expirationTime.Value - DateTime.Now : TimeSpan.FromHours(1);
